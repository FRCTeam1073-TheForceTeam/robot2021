...
public class ShooterControls extends CommandBase {
  ...
  public void execute() {
    ...
    // if
    // (OI.operatorController.getRawButtonPressed(XboxController.Button.kBumperLeft.value))
    // {
...
//    shooter.setHoodAngle(30.0 * Math.PI / 180.0);
    ...
    // OI.operatorController.getRawAxis(1));

    // shooter.setHoodPosition((shooter.minHoodPosition + shooter.maxHoodPosition) *
    // 0.5
    // + (shooter.maxHoodPosition - shooter.minHoodPosition) * 0.4 *
    // OI.operatorController.getRawAxis(1));
  }
