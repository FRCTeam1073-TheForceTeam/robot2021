...
public class TurnToHeadingCommand extends CommandBase {
   ...
   *                    radians per second.
   */
  public TurnToHeadingCommand(Drivetrain drivetrain, Bling bling, double targetHeading, double maxSpeed) {
   ...
   */
  public TurnToHeadingCommand(Drivetrain drivetrain, Bling bling, double targetHeading) {
