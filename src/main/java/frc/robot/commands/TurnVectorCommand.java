...
public class TurnVectorCommand extends CommandBase {
  ...
  public void initialize() {
    ...
    SmartDashboard.putNumber("[Turn] endAngle", endAngle);
  }
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber("[Turn] dot", dot);
    SmartDashboard.putNumber("[Turn] angle", angle);
    SmartDashboard.putNumber("[Turn] sign", sign);
  }
