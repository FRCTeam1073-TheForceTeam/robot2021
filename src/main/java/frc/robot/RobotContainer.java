...
public class RobotContainer {
    ...
    private final ShuffleboardWidgets shuffle = new ShuffleboardWidgets(drivetrain, collector, magazine, turret,
            shooter, cellTracker, portTracker);
    ...
    private void configureButtonBindings() {
        (new JoystickButton(OI.operatorController, XboxController.Button.kB.value))
                .whenPressed(new ParallelCommandGroup(new TurretPositionCommand(turret, 0),
    ...
    public Command getAutonomousCommand() {
        ...
        switch (ShuffleboardWidgets.auto) {
            case 0:
                return new CompetitionAutonomous(drivetrain, collector, magazine, turret, shooter, cellTracker,
                        portTracker, bling, 0);
            case 1:
                return new CompetitionAutonomous(drivetrain, collector, magazine, turret, shooter, cellTracker,
                        portTracker, bling, 1);
